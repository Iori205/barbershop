...
export default function MapSelector({
  ...
  }, [lat, lng, onLocationSelect, setLat, setLng]);

  return (
    <div>
      <div
        ref={mapRef}
        className="w-full h-64 rounded border border-gray-300 cursor-crosshair"
      />
      <p className="text-xs text-gray-500 mt-2">
        💡 Газрын зураг дээр дарж байршилаа сонгоно уу
      </p>
    </div>
  );
}
